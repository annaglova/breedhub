    ...
    return (
      <div className="relative h-full overflow-hidden">
        <div className={cn(
          ...
          <div ref={headerRef} className="z-20 flex flex-col justify-between border-b border-surface-border p-4 sm:p-7">
            <div className="w-full">
              <div className="flex w-full justify-between">
                <span className="text-4xl font-extrabold">{config.naming.title}</span>
                <ViewChanger views={config.viewConfig.map(v => v.id) as ViewMode[]} />
              </div>
        ...
        <>
          ...
          <div
            className={cn(
              ...
              drawerMode === "side" && "xl:w-[40rem] 2xl:w-[45rem]",
              drawerMode === "over" && "w-full max-w-[40rem]"
            )}
          >
