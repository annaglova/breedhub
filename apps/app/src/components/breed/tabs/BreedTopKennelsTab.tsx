    ...
    const mockKennels: AvatarEntity[] = [
      {
        ...
        avatarUrl:
          "https://api.dicebear.com/7.x/initials/svg?seed=Golden Heritage",
        url: "/kennel/1",
      },
      {
        id: "2",
      ...
      },
      {
        ...
        name: "Diamond Legacy",
        avatarUrl:
          "https://api.dicebear.com/7.x/initials/svg?seed=Diamond Legacy",
        url: "/kennel/4",
      },
      {
        id: "5",
        ...
        avatarUrl:
          "https://api.dicebear.com/7.x/initials/svg?seed=Platinum Pride",
        url: "/kennel/5",
      },
      {
        id: "6",
        ...
        avatarUrl:
          "https://api.dicebear.com/7.x/initials/svg?seed=Champions Choice",
        url: "/kennel/6",
      },
      {
        id: "7",
        ...
        avatarUrl:
          "https://api.dicebear.com/7.x/initials/svg?seed=Elite Breeding",
        url: "/kennel/7",
      },
      {
        id: "8",
        ...
        avatarUrl:
          "https://api.dicebear.com/7.x/initials/svg?seed=Noble Bloodline",
        url: "/kennel/8",
      },
      {
        id: "9",
        ...
        avatarUrl:
          "https://api.dicebear.com/7.x/initials/svg?seed=Supreme Quality",
        url: "/kennel/9",
      },
      {
        id: "10",
        ...
        avatarUrl:
          "https://api.dicebear.com/7.x/initials/svg?seed=Prestige Kennel",
        url: "/kennel/10",
      },
    ];
