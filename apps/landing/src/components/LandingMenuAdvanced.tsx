          ...
          {items.map((item) => (
            ...
            >
              <div className="flex items-start space-x-3">
                {item.icon && <span className="h-5 w-5 text-gray-400 mt-0.5">{item.icon}</span>}
                <div>
...
export default function LandingMenuAdvanced({ className, variant = 'default' }: LandingMenuAdvancedProps) {
    ...
    switch (variant) {
      ...
      case 'floating':
        return cn(
          ...
          isScrolled ? 'bg-white shadow-lg' : 'bg-white/80 backdrop-blur-sm shadow-md'
        );
      default:
          ...
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden lg:flex items-center space-x-8">
              <div className="flex items-center space-x-1">
                ...
                <DropdownMenu label="Resources" items={resourcesDropdownItems} />
              </div>
          ...
          <div className="absolute bottom-0 left-0 right-0 p-4 border-t bg-white">
            <div className="space-y-2">
              ...
              <Link to="/pricing" className="block">
                <Button className="w-full bg-primary-600 hover:bg-primary-700" onClick={() => setIsMobileMenuOpen(false)}>
                  Get Started Free
                </Button>
              </Link>
            </div>
