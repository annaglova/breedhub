...
class AppConfigStore {
  ...
  // ============= PROPERTY OPERATIONS (delegated to app-config-property) =============

  async createProperty(id: string, data: any) { return P.createProperty(this, id, data); }
  async createPropertyWithTags(id: string, data: any, tags: string[]) { return P.createPropertyWithTags(this, id, data, tags); }
  async updateProperty(id: string, data: any) { return P.updateProperty(this, id, data); }
  async deleteProperty(id: string) { return P.deleteProperty(this, id); }
  async updatePropertyWithIdChangeAndTags(oldId: string, newId: string, selfData: any, tags: string[]) { return P.updatePropertyWithIdChangeAndTags(this, oldId, newId, selfData, tags); }
  async updatePropertyWithIdChange(oldId: string, newId: string, selfData: any) { return P.updatePropertyWithIdChange(this, oldId, newId, selfData); }

  // ============= FIELD OPERATIONS (delegated to app-config-property) =============

  async addPropertyToField(fieldId: string, propertyId: string) { return P.addPropertyToField(this, fieldId, propertyId); }
  async removePropertyFromField(fieldId: string, propertyId: string) { return P.removePropertyFromField(this, fieldId, propertyId); }
  async updateFieldOverride(fieldId: string, overrideData: any) { return P.updateFieldOverride(this, fieldId, overrideData); }
  async addDependencyWithUI(fieldId: string, propertyId: string) { return P.addDependencyWithUI(this, fieldId, propertyId); }
  async removeDependencyWithUI(fieldId: string, depToRemove: string) { return P.removeDependencyWithUI(this, fieldId, depToRemove); }
