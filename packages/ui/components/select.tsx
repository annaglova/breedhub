...
const selectTriggerVariants = cva(
  "flex h-9 w-full items-center justify-between rounded-md border bg-white px-3 py-2 text-base text-slate-900 transition-all placeholder:text-slate-500 disabled:cursor-not-allowed disabled:opacity-50 [&>span]:line-clamp-1",
  {
    variants: {
      variant: {
        default: "border-slate-300 hover:border-primary-500 focus:border-primary-500 focus:outline focus:outline-[3px] focus:outline-primary-500/20 focus:outline-offset-0 disabled:hover:border-slate-300",
      ...
      size: {
        default: "h-9 px-3 py-2 text-base",
