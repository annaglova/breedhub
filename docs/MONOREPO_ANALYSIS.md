...
1. **Тиждень 1:** Реструктуризувати frontend в monorepo
2. **Тиждень 2:** Налаштувати type generation
3. **Тиждень 3:** Створити typed clients
4. **Тиждень 4:** Налаштувати CI/CD

Почніть з малого - просто розділіть apps/ та packages/ в поточному репозиторії!